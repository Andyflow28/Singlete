...
for input_file, zeta_value in input_files:
    ...
    if os.path.isfile(input_file):
        ...
        energy_new = np.linspace(0, 1.90, num=100)  # Crear 100 puntos entre 0 y 1.90
...
plt.xlim(0, 1.90)  # Establecer límites del eje X entre 0 y 1.90
plt.grid()
